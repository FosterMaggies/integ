...
if (!$item) { $_SESSION['notification'] = 'Customer not found.'; header('Location: customer.php'); exit; }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $db->update('customers', $id, $data, isset($_FILES['image']) ? ['image' => $_FILES['image']] : null);
